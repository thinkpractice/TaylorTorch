    ...
    targets: {
        var targets: [Target] = [
            ...
            .binaryTarget(
                name: "ATenCXX",
                url:
                    "https://github.com/thinkpractice/TaylorTorchBinaryPackage/releases/download/v0.2.0/ATenCXX.artifactbundle.zip",
                checksum: "fe35d0a24064f7a7f8f7b76dc5bfb6e315e43f22b24b89ea81dd868afafdeb27"
            )
        ]
